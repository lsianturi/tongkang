...
import com.gunungsewu.handler.NLHandler;
import com.gunungsewu.jtrac.JtracMain;
...
//        BotLogger.registerLogger(new ConsoleHandler());
        ...
        try {
            ...
            try {
            	...
            	telegramBotsApi.registerBot(new NLHandler());
            	JtracMain jtracMain = new JtracMain();
            	jtracMain.monitorTelegramQueue();
